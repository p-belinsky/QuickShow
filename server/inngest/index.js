...
const sendBookingConfirmationEmail = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    const localDate = new Date(booking.show.showDateTime).toLocaleDateString(
      "en-US"
    );
    const localTime = new Date(booking.show.showDateTime).toLocaleTimeString(
      "en-US",
    ...
    await sendEmail({
      ...
      body: `
        <div style="font-family: Arial, sans-serif; line-height: 1.5;">
          ...
          <p>
            <strong>Date:</strong> ${localDate}<br/>
        ...
        reminderTasks.map((task) =>
          sendEmail({
            ...
            body: `<div style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <p>Just a friendly reminder that your movie: </p>
